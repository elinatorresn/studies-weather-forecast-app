...
//  Weather App
//
//  Created by Elina Torres on 26/05/24.
//
...
class ViewController: UIViewController {
    ...
    private lazy var statsStackView: UIStackView = {
        ...
        stackView.translatesAutoresizingMaskIntoConstraints = false
        stackView.backgroundColor = UIColor.graySoft
    ...
    private var city = City(lat: "-25.0916", lon: "-50.1668", name: "Ponta Grossa")
    ...
    private func setConstraints(){
        ...
        NSLayoutConstraint.activate([
            dailyForecastLabel.topAnchor.constraint(equalTo: hourlyForecastCollectionView.bottomAnchor, constant: 28),
